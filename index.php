...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo">Kawan Kopi </a>
...
<div class="my-orders">
   ...
   <section>
      ...
      <div class="box">
         ...
         <p> total_orders : <span>RP<?= $fetch_orders['total_products']; ?></span> </p>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <img src="images/barista (2).png" alt="">
         <h3>Made With Love</h3>
         <p>Dibuat Dengan Sepenuh Hati Dan Kasih Sayang Ngoni Kall Minum Kopi Sini EHHHHHHHH Nd Ad Efek Sih wkwkwk</p>
      ...
      <div class="box">
         ...
         <h3>Chill And Fun</h3>
         <p>Tempatnya 100% Chill Nice For Having Good Quality Time W Friend Jadi Datang Jo Dpe Barista Le Ganteng Kta DRG BLG SIHH H3H3</p>
         <a href="#menu" class="btn">our menu</a>
      </div>

      <div class="box">
         <img src="images/barista (1).png" alt="">
         <h3>Price</h3>
         <p>Harga Murah Terjangkau Jadi Anak - Anak Kost Yang Akhir Bulan So Miskin Msih Boleh Mo Nongki :)</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
...
<section class="order" id="order">
   ...
   <?php
      ...
      <div class="flex">
         <div class="inputBox">
            <span>Nama :</span>
            <input type="text" name="name" class="box" required placeholder="Masukan Nama" maxlength="20">
         </div>
         <div class="inputBox">
            <span>Nomor Meja :</span>
            <input type="number" name="number" class="box" required placeholder="Masukan No Meja" min="0" max="9999999999" onkeypress="if(this.value.length == 10) return false;">
         </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>KawanKopiMegamas@gmail.com</p>
